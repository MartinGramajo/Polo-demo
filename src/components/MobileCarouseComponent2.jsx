...
import cliente from "../assets/img/slidersinfondo.png";
import cliente2 from "../assets/img/slidersinfondo2.png";
import cliente3 from "../assets/img/slider3sinfondo.png";
import { Link } from "react-router-dom";

const MobileCarouselComponent2 = () => {
  const settings = {
    dots: true,
    infinite: true,
...
export default MobileCarouselComponent2;
